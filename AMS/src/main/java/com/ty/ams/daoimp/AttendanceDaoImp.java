...
public class AttendanceDaoImp implements AttendanceDao {
	...
	@Override
	public List<Attendance> findAllAttendenceByDate(LocalDateTime date) {
		
		attendanceRepository.findByLoginDateandTime(date);
		return attendanceRepository.findByLoginDateandTime(date) ;
	}

	@Override
	public  List<Attendance> findAllAttendanceByAttendanceStatusAndDate(AttendanceStatus status, LocalDateTime date) {
		return attendanceRepository.findByAttendanceStatusAndLoginDateandTime(status, date);
	}
