...
public class UserController {
	...
	@Operation(description = "You Have to send a JSON Object and &nbsp; &nbsp; &nbsp;  "
			+ "userId will be Auto Generated by the system, &nbsp; &nbsp; &nbsp; "
			+ "password will be auto generated by the system &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;    NOTE: - no need to send timeSheets: [ ] and batchs: [ ] ", summary = "To Save User Object to Database...")
	...
	@Operation(description = "JSON Object should contain updated data allong with userId &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;   NOTE: - userId is must to update", summary = "To Update User Object...")
	...
	@Operation(description = "To Get the User Object we need to send The userId as Path Variable &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  Ex: - &nbsp; &nbsp; &nbsp; /user/5", summary = "To Find User Object By userID...")
	...
	@Operation(description = "To Delete an user Object Permanently pass userId as path variable     &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;   Example: - /user/5", summary = "To Delete User Object By userId...")
	...
	@Operation(description = "To Get All The Users from the Database  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  Ex: -&nbsp; /user/all", summary = "To Fetch All The Users From The Database")
	...
	@Operation(description = "To Get The Users by Category by passing the category as path variable &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Ex: - &nbsp; /user/category/LATERAL", summary = "To Find User Object By UserCategory...")
	@ApiResponses(value = { @ApiResponse(description = "User Found Successfully", responseCode = "200"),
	...
	@Operation(description = "To Get The Batch Timings Of A User by passing the userId as path variable &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Ex: - /user/timings/5", summary = "Fetch / Find Batch Timings Of A User by userId")
	...
	@Operation(description = "Send userId as path variable to updated the userStatus to IN_ACTIVE &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Ex: - /user/5 ", summary = "To Update The UserSatatus to IN_ACTIVE")
	@ApiResponses(value = {
